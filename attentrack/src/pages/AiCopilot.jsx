...
export default function AiCopilot() { return <PagePlaceholder title="AI Copilot" description="Your intelligent HR assistant for drafting policies, emails, and insights." />; }
